...
public class A_MinimumCharactersRequiredForPalindrome {
...
// since whole thing will be a palindrome, i.e. from the real centre to start of given string, that should also be a palindrome.
